...
async function updateAccount(req, res, next) {
  ...
  if (updateResult) {
    ...
    req.flash("notice", `The account for ${itemName} was successfully updated.`)

    // REFRESH COOKIE (So the header updates immediately)
...
async function changePassword(req, res, next) {
  ...
  if (updateResult) {
    const itemName = updateResult.account_firstname + " " + updateResult.account_lastname
    req.flash("notice", `The password for ${itemName} was successfully updated.`)
    res.redirect("/account/")
  } else {
